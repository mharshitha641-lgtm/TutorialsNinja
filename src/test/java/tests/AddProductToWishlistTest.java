...
public class AddProductToWishlistTest extends Basetest{
	    ...
	    public void addProductToWishlist() throws InterruptedException {
	        ...
	        homePage.searchProduct("Canon EOS");
	        homePage.addProductToWishlist("Canon EOS");

	        Thread.sleep(2000); // wait for success message
	        String message = homePage.getSuccessMessage();
	        Assert.assertTrue(message.contains("Canon EOS"), "Wishlist message not displayed correctly");
